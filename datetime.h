...
struct datetime
{
	//NOTE: It is very important that SecondsSinceEpoch is the only data member of datetime, because a datetime is a member of the parameter_value union (inca_model.h). Changing this may change the size of the parameter_value, which could break things.
